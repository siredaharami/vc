...
@Client.on_message(bad(["love"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["bad"]) & (filters.me | filters.user(SUDOERS)))
async def hearts(client: Client, message: Message):
    await phase1(message)
    await asyncio.sleep(SLEEP * 3)
...
@Client.on_message(bad(["rain"]) & (filters.me | filters.user(SUDOERS)))
async def hearts(client: Client, message: Message):
   await phase1(message)
   await asyncio.sleep(SLEEP * 3)
   await message.edit("🌬")
...
@Client.on_message(bad(["loveu"]) & (filters.me | filters.user(SUDOERS)))
async def _(client: Client, message: Message):
    noble = random.randint(1, len(NOBLE) - 2)
    reply_text = NOBLE[noble]
    await edit_or_reply(message, reply_text)

@Client.on_message(bad(["hmm"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["ahh"]) & (filters.me | filters.user(SUDOERS)))
async def hello_world(client: Client, message: Message):
...
@Client.on_message(bad(["gm"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["gn"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["shoot"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["brain"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["sex"]) & (filters.me | filters.user(SUDOERS)))
async def pijtau(client: Client, message: Message):
    if message.forward_from:
        return
    animation_interval = 1
...
@Client.on_message(bad(["bomb"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["call"]) & (filters.me | filters.user(SUDOERS)))
async def hajqag(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "`Me: Send Me The Client On My Telegram Account, I Will Fix The Bug & Send You.`",
        "`Saitama : Sure Sur \nTC Bye Bye :)`",
...
@Client.on_message(bad(["kill"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["theart"]) & (filters.me | filters.user(SUDOERS)))
async def gahah(client: Client, message: Message):
    if message.forward_from:
        return
    await message.edit("❤️")
...
@Client.on_message(bad(["wtf"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["ding"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["hypo"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["gangstar"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["charging"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["3d"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["fuck"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["hack"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["dino"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["cobra"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["helicopter"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["gf"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["dead"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["dlove"]) & (filters.me | filters.user(SUDOERS)))
async def drugs(client: Client, message: Message):
    await edit_or_reply(
        message,
...
@Client.on_message(bad(["rocket"]) & (filters.me | filters.user(SUDOERS)))
async def drugs(client: Client, message: Message):
    await edit_or_reply(
        message,
...
@Client.on_message(bad(["drugs"]) & (filters.me | filters.user(SUDOERS)))
async def drugs(client: Client, message: Message):
    await edit_or_reply(
        message,
        "`Drugs Everything...`          \n　　　　　|"
...
@Client.on_message(bad(["run"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["thumb"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["tank"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["cat"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["peg"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["nolove"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["scam"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["ror"]) & (filters.me | filters.user(SUDOERS)))
async def hearts(client: Client, message: Message):
    await phase1(message)
