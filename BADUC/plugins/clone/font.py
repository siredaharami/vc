...
from BADUC.database.tools import get_arg
...
@Client.on_message(bad(["font"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["listfont"]) & (filters.me | filters.user(SUDOERS)))
