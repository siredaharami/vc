...
from BADUC.database.parser import mention_html, mention_markdown

from BADUC import SUDOERS
from BADUC.core.command import *


@Client.on_message(bad(["admins", "adminlist"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["reportadmin", "reportadmins", "report"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["bots", "botlist"]) & (filters.me | filters.user(SUDOERS)))
