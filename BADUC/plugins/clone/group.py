...
@Client.on_message(bad(["setgcpic"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["setgcname"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["setgcbio"]) & (filters.me | filters.user(SUDOERS)))
