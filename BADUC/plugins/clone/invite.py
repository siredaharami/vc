...
@Client.on_message(bad(["invite"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["inviteall"]) & (filters.me | filters.user(SUDOERS)))
...
@Client.on_message(bad(["invitelink"]) & (filters.me | filters.user(SUDOERS)))
