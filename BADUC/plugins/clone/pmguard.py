...
@Client.on_message(bad(["pm", "pmpermit", "pmguard"]) & filters.me)
...
@Client.on_message(bad(["a", "approve"]) & filters.private  & filters.me)
...
@Client.on_message(bad(["da", "disapprove"]) & filters.private & filters.me)
...
@Client.on_message(bad(["block"]) & filters.me)
...
@Client.on_message(bad(["unblock"]) & filters.me)
