...
from BADUC.database import gbandb as Bad
...
# GBAN Function
@Client.on_message(bad(["gban"]) & (filters.me | filters.user(SUDOERS)))
async def gban_user(Client: Client, message: Message):
    ...
    if await Bad.gban_info(user.id):
...
# UNGBAN Function
@Client.on_message(bad(["ungban"]) & (filters.me | filters.user(SUDOERS)))
async def ungban_user(Client: Client, message: Message):
    ...
    if not await Bad.gban_info(user.id):
...
# GBAN List Function
@Client.on_message(bad(["listgban"]) & (filters.me | filters.user(SUDOERS)))
async def gbanlist(Client: Client, message: Message):
    users = await Bad.gban_list()
    ex = await message.reply_text("`Processing...`")
...
# GMUTE Function
@Client.on_message(bad(["gmute"]) & (filters.me | filters.user(SUDOERS)))
...
async def enforce_gmute(Client: Client, message: Message):
...
# UNGMUTE Function
@Client.on_message(bad(["ungmute"]) & (filters.me | filters.user(SUDOERS)))
...
# GMUTE List Function
@Client.on_message(bad(["listgmute"]) & (filters.me | filters.user(SUDOERS)))
...
async def enforce_gmute(Client: Client, message: Message):
    ...
    if await Bad.gban_info(user_id):
        try:
