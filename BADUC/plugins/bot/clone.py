...
PLUGINS_DIR = "BADUC/plugins/clone"
LOGGER_GROUP_ID = "PBX_CHAT"  # Replace with actual logger group ID or username
...
def copy_plugins():
    source_plugin_dir = "BADUC/plugins/clone"  # Assuming the main plugins are in CakeMusic/plugins
...
@bot.on_message(filters.command("sessiondelete"))
