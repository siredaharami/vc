...
@app.on_message(bad(["purge"]) & (filters.me | filters.user(SUDOERS)))
async def purgeMsg(client: Client, message: Message):
    ...
    Pbx = await app.edit(message, "__Purging...__")
    ...
    await app.delete(Pbx, f"__🧹 Purged {deleted} messages.__")


@app.on_message(bad(["purgeme"]) & (filters.me | filters.user(SUDOERS)))
async def purgeMe(client: Client, message: Message):
    ...
    try:
        ...
        return await app.delete(message, "Argument must be an integer.")
    ...
    await app.delete(Pbx, f"__🧹 Purged {count} messages.__")


@app.on_message(bad(["purgeuser"]) & (filters.me | filters.user(SUDOERS)))
...
@app.on_message(bad(["del"]) & (filters.me | filters.user(SUDOERS)))
...
@app.on_message(bad(["sd"]) & (filters.me | filters.user(SUDOERS)))
