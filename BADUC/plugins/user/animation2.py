...
@app.on_message(bad(["plain"]) & (filters.me | filters.user(SUDOERS)))
...
@app.on_message(bad(["mp3"]) & (filters.me | filters.user(SUDOERS)))
...
@app.on_message(bad(["snake"]) & (filters.me | filters.user(SUDOERS)))
async def pijtau(client: Client, message: Message):
    if message.forward_from:
        return
...
@app.on_message(bad(["mc"]) & (filters.me | filters.user(SUDOERS)))
async def pijtau(client: Client, message: Message):
    if message.forward_from:
        return
    animation_interval = 0.3
...
@app.on_message(bad(["nikal"]) & (filters.me | filters.user(SUDOERS)))
async def pijtau(client: Client, message: Message):
    if message.forward_from:
        return
