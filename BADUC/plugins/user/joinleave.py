...
@app.on_message(bad(["joingc"]) & (filters.me | filters.user(SUDOERS)))
...
@app.on_message(bad(["leavegc"]) & (filters.me | filters.user(SUDOERS)))
...
@app.on_message(bad(["leaveallgc"]) & (filters.me | filters.user(SUDOERS)))
...
@app.on_message(bad(["leaveallch"]) & (filters.me | filters.user(SUDOERS)))
